                ...
                <td className={tableStyles.cell}>
                  <div className="flex space-x-2">
                    <button
                      ...
                      className="px-3 py-1 text-sm font-medium text-white bg-blue-600 rounded hover:bg-blue-700 dark:bg-blue-500 dark:hover:bg-blue-600 transition-colors duration-150"
                    >
                      Quick Edit
                    </button>
                    <button
                      onClick={() => handleDelete(order.id)}
                      className="px-3 py-1 text-sm font-medium text-white bg-red-600 rounded hover:bg-red-700 dark:bg-red-500 dark:hover:bg-red-600 transition-colors duration-150"
                    >
                      Archive
                    </button>
                  </div>
